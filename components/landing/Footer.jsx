...
const Footer = () => {
  return (
    <>
      <div className="px-[1.2rem] md::px-[4rem] flex flex-col text-[#898989] justify-center items-center bg-[#1C1C1C] py-[2.5rem]">
      ...
      <div className="px-[1.2rem] md::px-[4rem] bg-black flex justify-center items-center text-[#CBCBCB] py-[0.8rem] text-center">
